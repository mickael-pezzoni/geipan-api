...
private class Temoignage {
    @Id
    private String _id;
    private int id_cas;
    private String id_temoignage;
    //private Date tem_chrono;
    private String obs_chrono;
    private String tem_nom_dossier;
    private String tem_resume;
    private String tem_Ti_type;
    private String tem_age;
    private String tem_genre;
    private String tem_adr_commune;
    private String cas_numEtude;
    private String tem_adr_CP;
    private String tem_adr_dpt;
    private String tem_adr_pays;
    private String tem_xp_activite_type;
    private String tem_xp_astro;
    private String tem_obs_moyen;
    private String tem_numSEPRA;
    private String id_observation;
    private String obs_nb;
    private String obs_commune_or_trajet;
    private String obs_AAAA;
    private String obs_MM;
    private String obs_JJ;
    private Date obs_date_heure;
    private String obs_heure_plage;
    private String obs_heure_delta;
    private String obs_duree_hms;
    private String obs_1_adr_commune;
    private String obs_1_adr_CP;
    private String obs_1_adr_dpt;
    private String obs_1_adr_pays;
    private String obs_1_adr_commune_2;
    private String obs_1_cadre_reference_type;
    private String obs_1_lat;
    private String obs_1_lon;
    private String obs_1_env_sol;
    private String obs_1_env_sol_type;
    private String obs_conditions_tem_activite;
    private String obs_1_heure;
    private String obs_1_azimut_lib;
    private String obs_1_elevation_lib;
    private String obs_1_alt;
    private String obs_1_trajectoire_lib;
    private String obs_1_tem_reaction_types;
    private String obs_conditions_apparition;
    private String obs_conditions_tem_activite_lib;
    private String obs_conditions_meteo;
    private String obs_conditions_meteo_lib;
    private String obs_conditions_astro_lib;
    private String obs_1_forme_lib;
    private String obs_conditions_disparition_txt;
